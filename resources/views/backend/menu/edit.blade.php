...
<section class="content">
        <div class="content-wrapper">
                  ...
                  <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('menu.index') }}" style="text-transform: capitalize;">Tất cả Danh Mục</a></li>
            ...
            <!-- Main content -->
            <section class="content">
                <form action="{{ route('menu.update',['menu'=>$menu->id]) }}" name="form1" method="post" enctype="multipart/form-data">
                    @method('PUT')
                <!-- Default box --> @csrf
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div>
                                ...
                                <select name="position" id="position" class="form-control bg-gray">
                                    <option value="mainmenu" {{ (old('status',$menu->position) == 'mainmenu') ? 'selected' : ''; }} >Main Menu</option>
                                    <option value="footermenu" {{ (old('status',$menu->position) == 'footermenu') ? 'selected' : ''; }} >Footer Menu</option>
