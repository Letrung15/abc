<div class="row">
    <div class="col-md-8">
        ...
        <div class="mb-3 ">
            ...
            <textarea name="metadesc" id="metadesc" cols="10" rows="5" class="form-control " placeholder=" ">{{ old('metadesc',$product->metadesc) }}</textarea>
        ...
        <div class=" mb-3">
            ...
            <textarea name="metakey" id="metakey" cols="10" rows="4" class="form-control " placeholder=" ">{{ old('metakey',$product->metakey) }}</textarea>
