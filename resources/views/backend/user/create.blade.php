                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="username" id="username" type="text" class="form-control " 
                                        placeholder="Điền tên tài khoản" value="{{ old('username') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="radio" name="gender" id="nam" value="0" {{ old('gender')==0?'checked':" " }} ><label
                                        for="nam">Nam</label>
                                    <input type="radio" name="gender" id="nu" value="1" {{ old('gender')==1?'checked':" " }} ><label for="nu">Nữ</label>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="image" id="image" type="file" class="form-control btn-sm" value="{{ old('image') }}">
                                    @if ($errors->has('image'))
                                    <div class="text-danger">
                                    {{ $errors->first('image') }}
                                    </div>    
