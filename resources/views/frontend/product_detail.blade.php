...
@section('content')
    ...
    <div class="text-info my-2"></div>

    <div class="ms-auto me-auto buy-amount form-qty text-center">
    ...
    <div class="row call-buy color-white text-center rounded py-2 mt-3">
        <div class="col-12">
            ...
            <button class="btn btn-success mx-1" onclick="add2cart(this.value)" value="{{ $product->id }}">
                Thêm vào giỏ hàng
            </button>

            <button class="btn btn-danger mx-1" onclick="add_wishlist(this.value)" value="{{ $product->id }}">
                Thêm vào yêu thích
            </button>
        </div>
    </div>
