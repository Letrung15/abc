...
class CustomerStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'password_re' => 'required|same:password|string|max:255',
            'email' => 'required|email|max:50',
            'phone' => 'required|string|max:12',
            'name' => 'required|string|unique:user,name|max:255',
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'username.unique' => 'Tên đã được sử dụng. Vui lòng chon tên khác',

            'password.required' => $messages['required'],
            'password.max' => $messages['max'] . ' từ',

            'password_re.required' => $messages['required'],
